...
<?php
      $successAlert = $forgotAlert = $wrongAlert = $citySearch = $alts = "";
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
          $citySearch = rawurlencode($_POST["city"]);
          $citySearch = preg_replace('/\s+/', '', $citySearch);
          $url = "https://api.openweathermap.org/data/2.5/weather?q=".$citySearch."&appid=24ad84cf65d4b8fb266e72266baab205";
